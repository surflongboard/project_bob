...
*Seeded 4 Sep 2026 from the SS26 DTC & Wholesale portfolio review. Reconciled against `config.py` 7 Sep 2026. Clearance treatment (REG-010/011/012), tier consolidation (REG-013), Generation Detail sheet (REG-014), and Core Assortment FW27 check (REG-015) added 8 Sep 2026. Update the live artifact first, then re-sync this file.*
