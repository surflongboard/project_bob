...
3. **8 Sep 2026 — Fixed a real bug in Tier Bench, found via QA.** Its four
...
4. **8 Sep 2026 — Pipeline made reusable.** Every column/sheet below that
...
5. **8 Sep 2026 — Added a stock breakdown by tier (REG-019).** A warehouse
   ...
   fire-saled.
6. **8 Sep 2026 — Added channel-mix columns (REG-017, REG-018).** Each
...
7. **8 Sep 2026 — Added FW27 assortment-status columns (REG-015,
