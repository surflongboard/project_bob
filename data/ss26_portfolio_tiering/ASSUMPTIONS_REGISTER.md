...
1. **9 Sep 2026 — Flowed regional tiering (REG-023/024) into Tier
   ...
   Hero+Near-Hero in Nordic (185.9% regional growth).
2. **9 Sep 2026 — The base tiering rule is confirmed (REG-024), and the
...
3. **9 Sep 2026 — Added region-relative tiering for Nordic and
...
4. **9 Sep 2026 — Added a Sales-by-Country sheet + a browse-order view
...
5. **9 Sep 2026 — Added Style Code(s) (REG-021), same day someone asked
   ...
   exports.
6. **9 Sep 2026 — Fixed a second Tier Bench data gap: YTD2026 units were
   ...
   `units25`; republished.
7. **9 Sep 2026 — Added real FY2025 Units (REG-020).** A `Units_2025`
...
8. **8 Sep 2026 — Fixed a real bug in Tier Bench, found via QA.** Its four
...
9. **8 Sep 2026 — Pipeline made reusable.** Every column/sheet below that
...
10. **8 Sep 2026 — Added a stock breakdown by tier (REG-019).** A warehouse
   ...
   fire-saled.
11. **8 Sep 2026 — Added channel-mix columns (REG-017, REG-018).** Each
...
12. **8 Sep 2026 — Added FW27 assortment-status columns (REG-015,
